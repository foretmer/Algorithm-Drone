...
#     data = np.load(file_path)
    # print(cat_data['center'])
    # print((data['points']))
    # print((cat_data['distances']))
...
plt.scatter(noise_points[:, 0], noise_points[:, 1], color = 'limegreen', s = 100,
            edgecolor = 'black', alpha = 0.7)

plt.title('Init Region Data Points', fontsize = 16)
