...
if __name__ == '__main__':
    ...
    while True:
        ...
        for i, center in enumerate(centers):
            ...
            num_selected_demands = len(selected_demands)
            num_d = num_d + num_selected_demands
        ...
        print("searching end")
        print("当前时间步：" + str(time))
        print("出动无人机次数：" + str(num_v))
        print("总投递点数：" + str(num_d))
        print("最优路径距离：", opt)
        plt.show()
